...
type ModelLister interface {
	...
	List(selector labels.Selector) (ret []*workloadv1alpha1.Model, err error)
...
type modelLister struct {
	listers.ResourceIndexer[*workloadv1alpha1.Model]
}

// NewModelLister returns a new ModelLister.
func NewModelLister(indexer cache.Indexer) ModelLister {
	return &modelLister{listers.New[*workloadv1alpha1.Model](indexer, workloadv1alpha1.Resource("model"))}
}

// Models returns an object that can list and get Models.
func (s *modelLister) Models(namespace string) ModelNamespaceLister {
	return modelNamespaceLister{listers.NewNamespaced[*workloadv1alpha1.Model](s.ResourceIndexer, namespace)}
}
...
type ModelNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*workloadv1alpha1.Model, error)
