...
type AutoscalingPolicyLister interface {
	...
	List(selector labels.Selector) (ret []*workloadv1alpha1.AutoscalingPolicy, err error)
...
type autoscalingPolicyLister struct {
	listers.ResourceIndexer[*workloadv1alpha1.AutoscalingPolicy]
}
...
func NewAutoscalingPolicyLister(indexer cache.Indexer) AutoscalingPolicyLister {
	return &autoscalingPolicyLister{listers.New[*workloadv1alpha1.AutoscalingPolicy](indexer, workloadv1alpha1.Resource("autoscalingpolicy"))}
}

// AutoscalingPolicies returns an object that can list and get AutoscalingPolicies.
func (s *autoscalingPolicyLister) AutoscalingPolicies(namespace string) AutoscalingPolicyNamespaceLister {
	return autoscalingPolicyNamespaceLister{listers.NewNamespaced[*workloadv1alpha1.AutoscalingPolicy](s.ResourceIndexer, namespace)}
}
...
type AutoscalingPolicyNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*workloadv1alpha1.AutoscalingPolicy, error)
