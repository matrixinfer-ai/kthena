...
type NetworkTopologySpecApplyConfiguration struct {
	Mode               *workloadv1alpha1.NetworkTopologyMode `json:"mode,omitempty"`
...
func (b *NetworkTopologySpecApplyConfiguration) WithMode(value workloadv1alpha1.NetworkTopologyMode) *NetworkTopologySpecApplyConfiguration {
	b.Mode = &value
	return b
}
