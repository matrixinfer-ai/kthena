...
<LightboxImage src="../assets/diagrams/diagrams/architecture/architecture_overview.svg" alt="Architecture Overview"/>
...
<div style={{ textAlign: 'center' }}>
    <LightboxImage src="../assets/diagrams/diagrams/architecture/request_pipeline.svg" alt="Request Processing Pipeline" />
</div>
