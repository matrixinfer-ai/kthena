...
- **AutoScalingPolicyBinding** – Attaches policies to target ModelServing workloads, supporting two modes: **Homogeneous** for metric-driven scaling of a single target and **Heterogeneous** for cost-aware distribution across heterogeneous instance types and engines (e.g., H100/A100).
