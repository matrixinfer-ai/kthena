...
<div style={{ textAlign: 'center' }}>
  <LightboxImage src="../assets/diagrams/architecture-autoscaler.svg" alt="architecture-autoscaler"></LightboxImage>
</div>
...
<LightboxImage src="../assets/diagrams/architecture-autoscaler-optimize-example.svg" alt="architecture-autoscaler-optimize-example"></LightboxImage>
