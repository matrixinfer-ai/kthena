...
##### **Scheduler (Gateway Component)**

The Infer Gateway includes a pluggable Scheduler that employs **advanced scheduling plugins** to optimize request routing and resource utilization:
